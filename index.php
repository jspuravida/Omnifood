...
<!--        This means phones shouldn't zoom-out; always have 1.0 scale-->
...
<!--   We need a row with 4 columns, so we use the grid file: span-1-of-4-->
...
<!--  Since we want the images to take up 100% of the width, we don't use rows here.-->
                    ...
                    <div class="plan-box">
                        ...
                        <div>
                            <ul>
                                ...
                                <li><i class="ion-ios-checkmark-empty icon-small"></i>Order from 8am - 12pm</li>
                    ...
                    <form method="post" action="mailer.php" class="contact-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col span-2-of-3">
                                <input type="text" name="name" id="name" placeholder="Jamie Oliver" required>
                            </div>    
                        </div>
        ...
        <footer>
            ...
            <div class="row">
                <p>
                    Copyright &copy; 2017 by Julian Salari. All rights reserved.
                </p>
            </div>
        </footer>
        
        <script src="https://cdn.jsdelivr.net/g/respond@1.4.1,html5shiv@3.7.3,selectivizr@1.0.3b"></script>
...
<!--        My own script is always the last one to be listed -->
